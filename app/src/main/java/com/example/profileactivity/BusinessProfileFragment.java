...
public class BusinessProfileFragment extends Fragment {
    ...
    private EditText mBusinessNameEditTxt, mLicenceNumEditTxt, mWebsiteEditTxt;
...
//        Toasty.success(view.getContext(), countryToPhonePrefix.getCountryIsoCode("+237674753811")).show();
        ...
        mBusinessNameEditTxt = view.findViewById(R.id.editText_1);
        mLicenceNumEditTxt = view.findViewById(R.id.editText1_1);
        mWebsiteEditTxt = view.findViewById(R.id.editText2_2);
            ...
            switch (v.getId()) {
                ...
                case R.id.choose_image:
                    ...
                    CropImage.activity()
                            ...
                            .setAspectRatio(1, 1)
                            .start(getContext(), BusinessProfileFragment.this);
                    break;
            }
        }
    };
